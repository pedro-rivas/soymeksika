      ...
      <div className="space-y-3 px-4 pb-4 pt-2">
        ...
        <label className="block space-y-1.5">
          ...
          <span className="relative block">
            <select
              ...
              className="w-full appearance-none rounded-lg border border-white/10 bg-zinc-900 px-3 py-2 pr-8 text-sm text-zinc-100 outline-none transition focus:border-amber-400/60 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading ? (
        ...
        <div className="flex items-center gap-3 pt-1">
          {playing ? (
            ...
            >
              <svg aria-hidden="true" viewBox="0 0 12 12" className="h-3 w-3">
                <path d="M3 1.7v8.6c0 .8.9 1.3 1.6.9l6.6-4.3a1 1 0 0 0 0-1.7L4.6.8a1 1 0 0 0-1.6.9Z" fill="currentColor" />
              </svg>
              Play animation
            </button>
          )}
